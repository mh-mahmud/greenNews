...
<head>
	...
	<title>Active Newspaper CMS</title>
        ...
        <div class="boxed">
            ...
            <div id="page-content">
                <div class="row">
                    ...
                    <div class="col-lg-4">
                    	<center><img id="logo-header" src="<?php echo base_url(); ?>uploads/others/logo_live.png" alt="Logo" class="img-responsive" style="width:250px;margin:10px;"></center>
                                ...
                                <?php echo form_open(base_url().'install/do_install' , array('id' => 'demo-bv-wz-form' , 'class' => 'form-horizontal'));?>
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div id="demo-bv-tab4" class="tab-pane  mar-btm text-center">
                                                ...
                                                <p class="text-muted rmb" style="display:block;">
                                                	Thank you for installing "Active Newspaper CMS". Best wishes for the next
                                                ...
                                                <div class="ads" style="display:none;">
                                                    ...
                                                    <a class="btn btn-info" target="_blank" href="https://u.to/fgipFA" style="margin-bottom:7px;">More info</a>
                                    ...
                                    <div class="panel-footer text-right" style="background-color: #fff;">
                                        <div class="box-inline">
                                            ...
                                            <button type="button" class="finish btn btn-success submitter" disabled>Install Newspaper CMS</button>
                                            <?php } ?>
                                        </div>
                                    </div>
                                </form>
                        ...
                        <center> <?php echo date("Y");?> &copy; All Rights Reserved @ <a href="about:blank">Active Newspaper CMS </a></center>

                        <center> Developed by <a href="https://activeitzone.com"><u><b>Active IT zone</b></u> , <?php echo date("Y");?> </a></center>
                    </div>
